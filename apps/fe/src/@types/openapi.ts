...
export interface paths {
    ...
    "/apis/v1/stories/{storyId}/comments/{commentId}": {
        ...
        /** 이야기 댓글 조회 */
        get: operations["StoriesCommentsController_getOneById"];
        put?: never;
        post?: never;
        /** 이야기 댓글 삭제 */
...
export interface components {
    schemas: {
        ...
        CreateStoryBodyDTO: {
             ...
             * @enum {string}
             */
            category?: "GENERAL_KNOWLEDGE" | "ETYMOLOGY" | "PURE_KOREAN" | "QUOTATION" | "INFORMATION" | "NONSENSE";
         ...
         * @enum {string}
         */
        StoryCategory: "GENERAL_KNOWLEDGE" | "ETYMOLOGY" | "PURE_KOREAN" | "QUOTATION" | "INFORMATION" | "NONSENSE";
         ...
         * @enum {string}
         */
        ReactionType: "GOOD" | "BAD" | "FIRE" | "SEE" | "HEART" | "SMILE" | "SAD" | "ANGRY" | "WOW" | "QUESTION";
        ...
        GetManyByKeywordResponseDTO: {
            /** @description 이야기 목록 */
            payload: components["schemas"]["GetManyByKeywordResponsePayloadDTO"][];
        };
        ...
        GetAllStoryByCategoryResponseDTO: {
            /** @description 이야기 목록 */
            payload: components["schemas"]["GetAllStoryByCategoryResponsePayloadDTO"][];
        };
        UpdateStoryBodyDTO: {
            /**
             * Format: uuid
        ...
        CreateStoryReactionBodyDTO: {
             ...
             * @enum {string}
             */
            type: "GOOD" | "BAD" | "FIRE" | "SEE" | "HEART" | "SMILE" | "SAD" | "ANGRY" | "WOW" | "QUESTION";
        };
...
export interface operations {
    ...
    StoriesCommentsController_getOneById: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GetOneByIdStoryCommentResponseDTO"];
                };
            };
        };
    };
